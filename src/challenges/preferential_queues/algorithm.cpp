...
/* ATENÇÃO: Para facilitar sua implementação, o clientes que chegam à loja foram fornecidos utilizando a estrutura de dados vector.
...
string PreferentialQueues::main(string input)
{
    ...
    for (int i = 0; i < total_clients; i++)
    {
        ...
        output += to_string(client.age) + " "
            //  + to_string(client.arrival_time) + " " + to_string(client.service_time) + "\n"
            ;
    }
